    ...
    emissions: {
        ...
        mainText: (
            <div className="flex justify-between text-2xl font-bold text-stone-900">
                <span>{Math.round(currentData.portfolioEmissionsTonnesCO2 || 0).toLocaleString("cs-CZ")} t CO₂e</span>
            </div>
        ),
    ...
    water: {
        ...
        mainText: (
            <div className="text-2xl font-bold text-cyan-950">
                {Math.round((currentData.portfolioWaterConsumptionLiters || 0) / 1000).toLocaleString("cs-CZ")} m³
            </div>
        ),
        comparisonHeader: "To je jako...",
        comparisons: (
        ...
        mainText: (
            <>
                ...
                <div className="text-xs text-emerald-800/70 mb-2">
                    Z toho budova: {Math.round(currentData.portfolioBuildingArea || 0).toLocaleString("cs-CZ")} m²
                </div>
            </>
        ),

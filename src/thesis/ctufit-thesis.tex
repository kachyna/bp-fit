...
\begin{tabular}{rl}
    ACC     & Annualized Capital Cost (anualizované kapitálové náklady) \\
    ...
    ESG     & Environmental, Social, and Governance (společenská odpovědnost a udržitelnost) \\
    EU      & Evropská unie \\
    FTE     & Full-Time Equivalent (přepočtený evidenční počet zaměstnanců) \\
    GB      & Gigabyte \\
    ...
    PESTLE  & Political, Economic, Social, Technological, Legal, Environmental (analýza vnějšího prostředí) \\

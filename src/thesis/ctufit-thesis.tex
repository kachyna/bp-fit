...
Výsledky naznačují, že z pohledu národního hospodářství není výstavba datových center jednoznačně přínosná, zejména z důvodu nízké tvorby pracovních míst a omezených daňových příjmů. Významnou limitací je rovněž kapacita přenosové soustavy a lokální dostupnost zdrojů vody pro chlazení. Ze strategického hlediska však rozvoj této infrastruktury hraje důležitou roli pro udržení technologické a národní suverenity.
...
\ctufitkeywordsCZE{datová centra, umělá inteligence, Česká republika, prediktivní model}
\ctufitkeywordsENG{data centers, artificial intelligence, Czech Republic, predictive model}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% END FILL IN
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
\begin{acknowledgmentpage}
	...
	Dále děkuji své rodině za dlouhodobou a neustávající podporu během studia.

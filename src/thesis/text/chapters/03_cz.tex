...
\begin{landscape} \begin{table}[p] \centering \setlength{\tabcolsep}{26pt}
    ...
    \begin{tabular}{llc}
        ...
        Výroba elektřiny    &   &    \\
        Spotřeba elektřiny    &   &    \\
        Max. transformační výkon    &   &    \\
        \quad Nízké zatížení sítě    &   &    \\
        \quad Běžné zatížení sítě    &   &    \\
        \quad Vysoké zatížení sítě    &   &    \\
        
        \addlinespace
        \midrule
        \addlinespace

        Roční úhrn srážek v ČR    &   &    \\
        Emisní faktor z výroby elektřiny    &   &    \\
        ...
        \quad Stand. sazba DFPO     &   &    \\
        \quad Odvody (zaměstnanec)    &   &    \\
        \quad Odvody (zaměstnavatel)    &   &    \\

        \addlinespace
        \midrule
        \addlinespace
        
        Sazba ekologické daně    &   &    \\
        Sazba daně z pozemku (kat. Y)    &   &    \\
        Sazba daně z budovy (kat. Y)    &   &    \\

        \addlinespace
        \bottomrule
    \end{tabular}
    
    \caption{Shrnutí kvantifikovatelných specifick ČR}

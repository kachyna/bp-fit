...
Fáze výstavby se obvykle odehrává v prvních 1--2 letech od zahájení projektu, kdy jsou realizovány stavební práce, instalace vybavení a další přípravné činnosti. V této fázi jsou klíčové investiční náklady, které se promítají do HPH vygenerované stavební firmou. Na základě dat z ČSÚ byl zjištěn průměrný koeficient pro výpočet HPH z investovaných nákladů, který se pohybuje kolem 30 \% \cite{cesky_statisticky_urad_mezispotreba_2026,cesky_statisticky_urad_produkce_2026}. HPH vygenerovaná ve fázi výstavby se tedy vypočítá jako

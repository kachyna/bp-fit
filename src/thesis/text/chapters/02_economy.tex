...
Prvním a nejviditelnějším dopadem jsou extrémní nároky na kapacitu sítě. Moderní AI kampusy vyžadují připojení v řádu stovek~MW, přičemž v budoucnu se plánují stavět centra s připojením až 1~GW~\cite[s.~5]{chen_electricity_2025}. Existující infrastruktura však na takovou zátěž zpravidla není připravená, kvůli čemuž vzniká časový nesoulad -- zatímco DC lze postavit za 1 až 2 roky, celý proces od plánování až po zprovoznění vysokonapěťové přenosové soustavy trvá 5 až 10 let
...
\begin{landscape} \begin{table}[p] \centering \setlength{\tabcolsep}{26pt}
    ...
    \begin{tabular}{llc}
        ...
        \quad Náklady: hrubá stavba a budova (20,9~\%) & 2,09 až 2,299 mil. USD &~\cite{pham_data_2017} \\
        \quad Náklady: infrastruktura (72,9~\%) & 7,29 až 8,02 mil. USD &~\cite{pham_data_2017,ginzburg-ganz_technical_2025} \\

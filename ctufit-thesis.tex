...
\includepdf[pages={1-}]{kachyren-assignment.pdf} % replace this file with your thesis assignment generated from ProjectsFIT
...
\include{text/chapters/01_history_demands}

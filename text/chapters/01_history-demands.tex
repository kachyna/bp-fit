...
\begin{table}[t] \centering \setlength{\tabcolsep}{4pt}
    ...
    \caption{Souhrn požadavků pro klasifikaci Tier~\cite[s.~13]{turner_iv_tier_2008}. N označuje kritickou kapacitu nezbytnou pro podporu aktuálního IT zatížení.}

...
Následuje slovní popis požadavků v klasifikaci Tier, podle které se určuje dostupnost služeb poskytovaných datovým centrem pro koncové uživatele. Tyto popisy jsou převzaty přímo ze specifikace Uptime Institute~\cite{turner_iv_tier_2006}:
